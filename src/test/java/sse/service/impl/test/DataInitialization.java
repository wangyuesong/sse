...
public class DataInitialization extends BaseJPATest {
    ...
    public void test() {
        ...
        menus.add(new Menu("所有老师", menufbn("指导教师"), "Student",
                "http://localhost:8080/sse/dispatch/student/all_teachers"));
        menus.add(new Menu("填报志愿", menufbn("指导教师"), "Student", "http://localhost:8080/sse/dispatch/student/select_will"));
        menus.add(new Menu("我的老师", menufbn("指导教师"), "Student", ""));
        for (Menu m : menus)
        {
            em.persist(m);
        }
